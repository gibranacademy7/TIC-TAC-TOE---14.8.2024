...
class MemoryGame:
    ...
    def create_widgets(self):
        # Title
        title = tk.Label(self.master, text="MEMORY GAME", font=('Arial', 24))
        title.grid(row=0, column=0, columnspan=4)

        # Create grid of buttons
        for i in range(16):
            button = tk.Button(self.master, width=6, height=3, command=lambda i=i: self.reveal_card(i), bg='lightgray')
